  ...
  return (
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ? "0 0 10px rgba(255,255,255,0.25), 0 0 6px rgba(200,200,200,0.35)"
          : "none",
      ...
      className={cn(
        ...
        visible &&
          "bg-white/30 dark:bg-neutral-900/40 border border-white/40 backdrop-blur-xl",
        className
      )}
    >
      {children}
  ...
  return (
    ...
    >
      ...
      <span className="font-medium text-2xl text-black dark:text-white">
        Capybara
        {/* <span
          className={`${font.className} text-lg bg-gradient-to-r
